package com.account.work.adapter.base;
...
/**
 * RecyclerView Adapter Package base class<br>
 */
...
public abstract class RecyclerBaseAdapter<T> extends RecyclerView.Adapter<RecyclerBaseAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate((getLayoutId(viewType)) == 0?itemLayoutId :(getLayoutId(viewType)), parent, false);
